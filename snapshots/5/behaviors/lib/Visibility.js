...
(function() {
  ...
  define(['lib/Geometry'], function(_arg) {
    var EndPoint, Point, Segment, Visibility;
    ...
    return {
      ...
      Visibility: Visibility = (function() {
        ...
        Visibility.prototype.ResetSegments = function() {
          this.segments = [];
          return this.endpoints = [];
        };

        Visibility.prototype.AddSegments = function(segments) {
          var seg, _i, _len, _results;
          _results = [];
          for (_i = 0, _len = segments.length; _i < _len; _i++) {
            seg = segments[_i];
            _results.push(this.addSegment(seg.p1.x, seg.p1.y, seg.p2.x, seg.p2.y));
          }
          return _results;
        };
